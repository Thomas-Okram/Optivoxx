...
const ServiceCard = ({ service }: { service: ServiceItem }) => (
  ...
  >
    ...
    <p className="mb-7 text-[21px] leading-[1.4]">{service.description}</p>
    <Link
      href={service.link}
...
export default function ServicesSection({
  title = "Empowering your business and career with advanced software solutions and IT education.",
  services,
