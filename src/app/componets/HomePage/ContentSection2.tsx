...
export default function ContentSection2({
  ...
  bulletPoints,
  imagePosition = "right",
  ctaText = "Get In Touch", // Default CTA text
  ctaLink = "#contact", // Default CTA link
            ...
            >
              ...
              <div className="">
                ...
                <div className="mt-8 text-center">
                  <a
                    href={ctaLink}
                    className="inline-block px-6 py-3 bg-emerald-600 text-white text-lg font-semibold rounded-md hover:bg-emerald-700 transition duration-500 transform hover:scale-105 hover:shadow-lg"
                  >
                    {ctaText}
                  </a>
                </div>
