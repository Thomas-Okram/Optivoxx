...
interface ContentSection1Props {
  ...
  description2: string;
  imageSrc: string;
  ctaText: string; // Add ctaText prop
  ctaLink: string; // Add ctaLink prop
}
        ...
        <div className="global-container">
          <div className="grid items-center gap-10 md:grid-cols-[minmax(0,_1fr)_1.3fr] lg:gap-[60px] xl:gap-x-[94px]">
            ...
            <div className="jos" data-jos_animation="fade-right">
              ...
              {/* Section Content Block */}
              <div>
                <p className={pStyle}>{description1}</p>
                <p className={pStyle}>{description2}</p>
                <Link
                  rel="noopener noreferrer"
                  href={ctaLink} // Use dynamic ctaLink
