...
const mblNavLinkStyle =
  "block hover:text-gray-300 transition-colors py-2 px-4 text-lg font-normal border-b border-white/10 pb-1 hover:border-white poppins-regular";

const desktopNavLinkStyle =
  "hover:text-gray-300 transition-colors py-2 px-4 text-lg font-normal poppins-regular";
        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center">
            <Image
              ...
              className="mr-2"
            />
            <span className="text-xl font-semibold">Optivoxx Technologies</span>
          </Link>
